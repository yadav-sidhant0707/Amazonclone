...
<meta charset="ISO-8859-1">
 ...
 <meta charset="utf-8">
    ...
    <title>ItemMaster list | amazon</title>
...
<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">ItemMaster   </h2>    			 
				</div>			 		
			</div>
<h1 style="text-align:center">ItemMaster List</h1>
...
<%
    ...
    try
		...
		out.println("<tr><th>Item ID</th><th>Item Name</th><th>Company ID</th><th> Category ID</th><th> Brand ID</th><th>Item Rate</th><th>Item Stock</th><th>Item Description</th><th>Item Photo</th></tr>");

		while (rs.next()) {

			out.println(
			"<tr><th>" + rs.getInt(1) + "</th><th>" + rs.getString(2) +"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"</th><th>"+rs.getString(5)+"</th><th>"+rs.getString(6)+"</th><th>"+rs.getString(7)+"</th><th>"+rs.getString(8)+"</th><th>"+rs.getString(9)+"</th></th></tr>");
