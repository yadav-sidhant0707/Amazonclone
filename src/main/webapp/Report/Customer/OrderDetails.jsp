...
<meta charset="ISO-8859-1">
 ...
 <meta charset="utf-8">
    ...
    <title>OrderDetails List | amazon</title>
...
<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">OrderDetails   </h2>    			 
				</div>			 		
			</div>
<h1 style="text-align:center">OrderDetails List</h1>
...
<%
...

	{
		...
		out.println(
		"<tr><th>Order Detailed ID</th><th>Order ID </th><th>Item ID</th><th>Item Rate</th><th>	Item Quantity</th><th>Item Amount</th></tr>");
