...
<meta charset="utf-8">
    ...
    <title>company_wise_ordermaster | amazon</title>
...
<title>company_wise_ordermaster</title>
</head>
<body>
							...
							{	
							     ...
							     rs=st.executeQuery("select ordermaster.orderId,  ordermaster.orderDate,  ordermaster.orderCustId, ordermaster.orderCompId, ordermaster.orderAmt, ordermaster.orderGSTAmt ,ordermaster.orderGrandTot  FROM  ordermaster  INNER JOIN  company ON  ordermaster.orderCompId = company.compId and  ordermaster.orderCompId="+request.getParameter("cid"));
									...
									while (rs.next()) {
										...
										out.println(
										"<tr><th>" + rs.getInt(1) + "</th><th>" + rs.getString(2) +"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"</th><th>"+rs.getString(5)+"</th><th>"+rs.getString(6)+"</th><th>"+rs.getString(7)+"</th>"+"</tr>");
