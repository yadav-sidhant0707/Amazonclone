...
<meta charset="utf-8">
    ...
    <title>ordermaster Wise dates | amazon</title>
...
<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Ordermaster wise order Form </h2>    			 
				</div>			 		
			</div>
...
<input type="submit" value="Show" class="btn btn-primary pull-rightc center" name="b1"> 
</div>
<br><br><br><br>
<%
						   ...
						   try
							{
							 				  ...
							 				  ResultSet  rs=st.executeQuery("SELECT  OrderMaster.orderId,   OrderMaster.orderDate,   OrderMaster.orderCustId,  OrderMaster.orderCompId ,   OrderMaster.orderAmt , OrderMaster.orderGSTAmt , OrderMaster.orderGrandTot FROM  OrderMaster  INNER JOIN  OrderDetails  ON OrderMaster.orderId =  OrderDetails.orderId  and OrderMaster.orderDate  between'"+request.getParameter("t1")+"' and '"+request.getParameter("t2")+"'");

							 				out.println("<table border='3px;' class='table'>");
								        	out.println("<tr><th>Order ID</th><th>order Date</th><th>Order customer ID</th><th>Order Comapany ID </th><th>Order amount</th><th>Order  GST amount </th><th>Order Grand total</th></tr>");
								            while(rs.next())
								             {
								           	
								          
								           	
								        	   out.println("<tr><th>"+rs.getInt(1)+"</th><th>"+rs.getString(2)+"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"</th> <th>"+rs.getString(5)+"</th><th>"+rs.getString(6)+"</th><th>"+rs.getString(7)+"</th></tr>");						
								             }
