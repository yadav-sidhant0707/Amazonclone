...
<meta charset="utf-8">
    ...
    <title>Item wise order | amazon</title>
...
<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Item wise order  </h2>    			 
				</div>			 		
			</div>
...
<h1>Item  List</h1>
				...
				%> 
				<option value=<%=itemId%> ><%=itemNm%></option>
					...
					if(request.getParameter("b1")!=null)
					{
						 ...
						 try
							{	
							     ...
							     rs=st.executeQuery("select orderdetails.orderDetId, orderdetails.orderId,itemmaster.itemNm, orderdetails.itemRate, orderdetails.itemQty,orderdetails.itemAmt   FROM orderdetails  INNER JOIN  itemmaster ON  orderdetails.ItemId = itemmaster.itemId  and  orderdetails.ItemId="+request.getParameter("cid"));


							     out.println("<table border='3px;' class='table'>");
									out.println(
									"<tr><th>Order Detailed ID</th><th>Order ID </th><th>Item Name</th><th>Item Rate</th><th>	Item Quantity</th><th>Item Amount</th></tr>");

									while (rs.next()) {

										out.println("<tr><th>" + rs.getInt(1) + "</th><th>" + rs.getString(2) +"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"</th><th>"+rs.getString(5)+"</th><th>"+rs.getString(6)+"</th></tr>");
