...
<meta charset="utf-8">
    ...
    <title>Brand wise item | amazon</title>
...
<header id="header"><!--header-->
	 ...
	 <div id="contact-page" class="container">
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Brand wise item List</h2>    			 
				</div>			 		
			</div>
					...
					if(request.getParameter("b1")!=null)
					{
						 ...
						 try
							{	
							     ...
							     rs=st.executeQuery("SELECT itemmaster.itemId,itemmaster.itemNm,itemmaster.itemRate,itemmaster.itemStock,itemmaster.itemDescr,itemmaster.itemPhoto,brand.brandNm, itemcat.catNm,company.compNm FROM itemmaster  INNER JOIN brand ON itemmaster.brandId=brand.brandId INNER JOIN company ON itemmaster.compId = company.compId INNER JOIN itemcat ON itemmaster.catId = itemcat.catId  and  itemmaster.brandid="+request.getParameter("cid"));


							     out.println("<table border='3px;' class='table'>");
									out.println("<tr><th>Item ID</th><th>Item Name</th><th>Item Rate</th><th>Item Stock</th><th>Item Description</th><th>Item Photo</th><th>  Brand Name </th><th> Company Name</th><th>Category Name</th></tr>");
