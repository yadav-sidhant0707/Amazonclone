...
<meta charset="utf-8">
    ...
    <title>Category Wise Item | amazon</title>
					...
					if(request.getParameter("b1")!=null)
					{
						 ...
						 try
							{	
							     ...
							     rs=st.executeQuery("SELECT itemmaster.itemId,itemmaster.itemNm,itemmaster.itemRate,itemmaster.itemStock,itemmaster.itemDescr,itemmaster.itemPhoto,itemcat.catNm,"
							    		 +"company.compNm,brand.brandNm FROM itemmaster INNER JOIN itemcat"
							    		 +"ON itemmaster.catId = itemcat.catId INNER JOIN"
							    		 +"company ON itemmaster.compId = company.compId INNER JOIN"
							    		 +"brand ON itemmaster.brandId =  brand.brandId and" 
							    		 +"itemmaster.catId="+request.getParameter("cid"));


							     out.println("<table border='3px;' class='table' >");
									out.println("<tr><th>Item ID</th><th>Item Name</th><th>Item Rate</th><th>Item Stock</th>"
									+"<th>Item Description</th><th>Item Photo</th><th>  CategoryName</th>"
									+"<th> Company Name</th><th>Brand Name</th></tr>");

									while (rs.next()) {

										out.println(
										"<tr><th>" + rs.getInt(1) + "</th><th>" + rs.getString(2) 
										+"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)
										+"</th><th>"+rs.getString(5)+"</th><th>"+rs.getString(6)+"</th><th>"
										+rs.getString(7)+"</th><th>"+rs.getString(8)+"</th><th>"+rs.getString(9)+"</th></tr>");
